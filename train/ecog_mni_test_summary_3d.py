...
for model_root in glob.glob('/home/wangnxr/models/*ellipv2*itr_0*_3900_3d_best.h5'):
    ...
    with open("/home/wangnxr/results/%s.txt" % model_root_name, "w") as summary_writer:
		...
		if sbj == "c95":
			true = 1-true
		if model_root_name.split("_")[-5] == "c95":
			true = 1-true
                true_0 = 0
                true_1 = 0
