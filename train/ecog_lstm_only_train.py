...
for itr in xrange(3):
    for s, sbj in enumerate(sbj_ids):
        ...
        for t, time in enumerate(start_times):
            ...
            ecog_series = Input(shape=(1000,1,len(channels),1))

            x = TimeDistributed(Flatten(), name='flatten')(ecog_series)
            ...
            model_savepath = "/home/wangnxr/models/ecog_model_lstm_only_%s_itr_%i_t_%i_v2_" % (sbj,itr,time)
