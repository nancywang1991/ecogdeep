...
dgdx = train_datagen.flow_from_directory(
        ...
        '/home/wangnxr/dataset/ecog_offset_0_a0f/train/',
        batch_size=24,
        target_size=(1,64,1000),
        class_mode='categorical')
dgdx_val = test_datagen.flow_from_directory(
        #'/mnt/cb46fd46_5_no_offset/test/',
        '/home/wangnxr/dataset/ecog_offset_0_a0f/test/',
        batch_size=20,
        shuffle=False,
        target_size=(1,64,1000),
        class_mode='categorical')
...
def f_nn(params):
    ...
    model.save("/home/wangnxr/model_ecog_1d_%s_mj_a0f.h5" % "_".join([str(param) for param in params]))
    pickle.dump(history_callback.history,open("/home/wangnxr/history_ecog_1d_%s_mj_a0f.p" % "_".join([str(param) for param in params]), "wb"))
