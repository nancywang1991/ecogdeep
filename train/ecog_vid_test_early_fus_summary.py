...
with open("/home/wangnxr/results/ecog_vid_lstm_early_fus_summary_results.txt", "wb") as summary_writer:
        ...
        for t, time in enumerate(start_times):
            ...
            for itr in xrange(3):
                model_files = glob.glob(
                    '/home/wangnxr/models/ecog_vid_model_lstm_early_fus_%s_itr_%i_t_%i_*chkpt.h5' % (sbj, itr, time))
