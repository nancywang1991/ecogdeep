...
dgdx = train_datagen.flow_from_directory(
        ...
        '/home/wangnxr/dataset/ecog_offset_0_arm_test1day/train/',
        batch_size=25,
        target_size=(1,64,1000),
        class_mode='binary')
dgdx_val = test_datagen.flow_from_directory(
        #'/mnt/cb46fd46_5_no_offset/test/',
        '/home/wangnxr/dataset/ecog_offset_0_arm_test1day/test/',
        batch_size=16,
        shuffle=False,
        target_size=(1,64,1000),
        class_mode='binary')
...
def f_nn(params):
    ...
    model.save("/home/wangnxr/results/nn/model_ecog_1d_%s_test1day_small_filt.h5" % "_".join([str(param) for param in params]))
    pickle.dump(history_callback.history,open("/home/wangnxr/results/nn/history_ecog_1d_%s_test1day_small_filt.p" % "_".join([str(param) for param in params]), "wb"))

    loss = history_callback.history["val_loss"][-1]

    return loss

params_list = [(1,3,1,3),(1,10,1,3)]
losses = []
